...
static __float128 ciede2000_with_parameters(__float128 l1, __float128 a1, __float128 b1, __float128 l2, __float128 a2, __float128 b2, __float128 kl, __float128 kc, __float128 kh, int canonical) {
	...
	const __float128 pi_1 = 3.141592653589793238462643383279502884q;
	const __float128 pi_3 = 1.047197551196597746154214461093167628q;
	...
	const __float128 h_mean = h_mean_raw - (canonical && pi_1 + 1E-14q < h_mean_raw ?
		1.0q : // canonical=1 acts like Gaurav Sharma, OpenJDK, ...
		-1.0q  // canonical=0 acts like Bruce Lindbloom, Netflix’s VMAF, ...
	) * hue_wrap * pi_1;
...
static inline __float128 ciede2000(__float128 l1, __float128 a1, __float128 b1, __float128 l2, __float128 a2, __float128 b2) {
	return ciede2000_with_parameters(l1, a1, b1, l2, a2, b2, 1.0q, 1.0q, 1.0q, 0);
}
