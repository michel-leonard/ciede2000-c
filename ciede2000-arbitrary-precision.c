...
static void ciede2000_arbitrary_precision(struct delta_e *manager) {
	...
	static const mpfr_rnd_t rnd = MPFR_RNDN; // round to nearest (precision required = 15 + 3.35 * n_correct_decimals)
	...
	// Note: This CIEDE2000 does not perform degree/radian conversions, it deals only with radians
	...
	if (mpfr_cmp(*my_interoperability_pi, *delta_h) < 0) {
		// Michel Leonard 2026 - When mean wraps, difference wraps toos
...
////////////////////////////////////////////////////////////////////////////////////
////////////                                                            ////////////
////////////               ALLOCATES/CLEARS THE MEMORY FOR              ////////////
////////////               THE ARBITRARY PRECISION NUMBERS              ////////////
////////////                                                            ////////////
////////////////////////////////////////////////////////////////////////////////////
