...
static double ciede2000_with_parameters(double l1, double a1, double b1, double l2, double a2, double b2, double kl, double kc, double kh, int canonical) {
	...
	const double pi_1 = 3.141592653589793238462643383279502884;
	const double pi_3 = 1.047197551196597746154214461093167628;
	...
	const double h_mean = h_mean_raw - (canonical && pi_1 + 1E-14 < h_mean_raw ?
		1.0 : // canonical=1 acts like Gaurav Sharma, OpenJDK, ...
		-1.0  // canonical=0 acts like Bruce Lindbloom, Netflix’s VMAF, ...
	) * hue_wrap * pi_1;
...
static inline double ciede2000(double l1, double a1, double b1, double l2, double a2, double b2) {
	return ciede2000_with_parameters(l1, a1, b1, l2, a2, b2, 1.0, 1.0, 1.0, 0);
}
